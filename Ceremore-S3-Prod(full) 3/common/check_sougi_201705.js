...
function check_form(){
	...
	$("form :input").blur(function() {
		...
		$(":text,[type='tel'],[type='email']").filter(".validate").each(function(){
			...
			$(this).filter(".ziprequirement").each(function(){
				if(rqradress && $(this).val()==""){
			...
			$(this).filter(".cityrequirement").each(function(){
				if(rqradress && $(this).val()==""){
	...
	$("form").submit(function(){
		...
		console.log('rqradress',rqradress);
